 ...
 */
    ...
    #define TIMEZONE_NAME_DEFAULT       "Europe/Helsinki"           /** @brief defines default time zone name */
    #define TIMEZONE_RULE_DEFAULT       "EET-2EEST,M3.5.0/3,M10.5.0/4"              /** @brief defines default time zone rule */
